    ...
    <Card className="card-modern overflow-hidden">
      ...
      <CardContent className="p-4 space-y-3">
        ...
        <div className="text-xs text-muted-foreground space-y-1">
          <p>
            📍{' '}
            {getTranslation(language, 'walkingDistance') ||
              'Walking distance from Den Helder Centraal Station: 8 minutes'}
          </p>
          <p>
            🚗 {getTranslation(language, 'parkingInfo') || 'Free street parking available nearby'}
          </p>
        </div>
      </CardContent>
    </Card>
