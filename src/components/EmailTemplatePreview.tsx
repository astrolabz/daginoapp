        ...
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-lg bg-secondary/20 border space-y-3">
            <div className="space-y-2">
              ...
              <div className="text-sm text-muted-foreground font-mono">{emailContent.subject}</div>
            </div>

            <div className="space-y-2">
              <div className="text-sm font-medium text-foreground">{content.previewLabel}</div>
              <div className="text-sm text-muted-foreground italic">{emailContent.preview}</div>
            </div>
          </div>
          ...
          <div className="grid gap-2 text-sm">
            {content.highlights.map((highlight, index) => (
              <div
                key={`${templateType}-highlight-${index}`}
