...
export const translations = {
  it: {
    ...
    description:
      "Benvenuti sul sito web della Pizzeria Da Gino a Den Helder! Qui potete gustare l'autentica cucina italiana con ingredienti freschi.",
    ...
    menuDescription:
      'Piatti tradizionali preparati con ingredienti freschi e ricette tramandate di generazione in generazione',
    popular: 'Popolare',
    ...
    traditionDesc:
      "Dal 2010 portiamo a Den Helder l'autentica tradizione culinaria italiana con ricette tramandate",
    passion: 'Passione',
    passionDesc: "Ogni piatto è preparato con amore e dedizione per offrire un'esperienza unica",
    quality: 'Ingredienti Freschi',
    qualityDesc:
      'Utilizziamo solo ingredienti freschi e di prima qualità, selezionati con cura per garantire il massimo sapore',
    ...
    reviewsDescription:
      'Scopri cosa dicono i nostri clienti sulla loro esperienza gastronomica italiana',
    ...
    // Additional info
    allergyNotice:
      "Gestiamo le vostre allergie o intolleranze alimentari con la massima attenzione durante la preparazione dei nostri piatti. La contaminazione incrociata di allergeni non può mai essere completamente esclusa nella nostra cucina. Vi preghiamo di indicare chiaramente le vostre allergie o intolleranze al momento dell'ordine!",
    deliveryInfo:
      "Cerchiamo sempre di consegnare il tuo ordine il più rapidamente possibile. La domenica e nei giorni festivi, i tempi di consegna potrebbero allungarsi a causa dell'elevata domanda.",
    ...
    reservationDescription:
      'Prenota il tuo tavolo tramite il nostro widget ufficiale TheFork e assicurati il posto in pochi secondi.',
    reservationTheForkDisclaimer:
      'Le prenotazioni vengono gestite direttamente da TheFork; riceverai conferma immediata dal loro sistema.',
    ...
    reservationPolicy:
      'Le prenotazioni vengono confermate telefonicamente entro 2 ore. Ti preghiamo di arrivare puntuale per mantenere il tuo tavolo.',
    confirmationCall:
      'Riceverai una chiamata di conferma dal nostro staff per confermare la prenotazione.',
    arrivalTime:
      "Ti preghiamo di arrivare all'orario prenotato. I tavoli vengono mantenuti per 15 minuti dopo l'orario prenotato.",
    ...
    emailConfirmationDescription:
      'Ti abbiamo inviato una email di conferma. Controlla la tua casella di posta e clicca sul link per confermare la prenotazione.',
    ...
    confirmationEmailMessage:
      'Grazie per aver scelto il Ristorante Da Gino! Per confermare la tua prenotazione, clicca sul pulsante qui sotto:',
    ...
    exploreDescription:
      'Scopri tutto quello che abbiamo da offrire: dalla nostra cucina autentica ai nostri servizi',
    beverages: 'Bevande',
    beveragesDescription:
      'Scopri la nostra selezione di vini italiani, birre artigianali e bevande',
    services: 'Servizi',
  ...
  en: {
    ...
    description:
      'Welcome to Pizzeria Da Gino in Den Helder! Here you can enjoy authentic Italian cuisine with fresh ingredients.',
    ...
    ourMenu: 'Our Menu',
    menuDescription:
      'Traditional dishes prepared with fresh ingredients and recipes passed down through generations',
    popular: 'Popular',
    ...
    tradition: 'Tradition',
    traditionDesc:
      'Since 2010, we bring authentic Italian culinary tradition to Den Helder with time-honored recipes',
    passion: 'Passion',
    passionDesc: 'Every dish is prepared with love and dedication to offer a unique experience',
    quality: 'Fresh Ingredients',
    qualityDesc:
      'We use only fresh, premium ingredients, carefully selected to ensure maximum flavor',
    ...
    // Additional info
    allergyNotice:
      'We handle your allergies or food intolerances with the utmost care during the preparation of our dishes. Cross-contamination of allergens can never be completely excluded in our kitchen. Please clearly indicate your allergies or intolerances when ordering!',
    deliveryInfo:
      'We always try to deliver your order as quickly as possible. On Sundays and holidays, delivery times may be longer due to high demand.',
    ...
    reservationDescription:
      'Book your table through our official TheFork widget and secure your seat in seconds.',
    reservationTheForkDisclaimer:
      "Reservations are handled directly by TheFork; you'll receive an instant confirmation from their system.",
    ...
    reservationPolicy:
      'Reservations are confirmed by phone within 2 hours. Please arrive on time to keep your table.',
    confirmationCall:
      'You will receive a confirmation call from our staff to confirm your reservation.',
    arrivalTime:
      'Please arrive at your booked time. Tables are held for 15 minutes after the booked time.',
    ...
    emailConfirmationDescription:
      'We have sent you a confirmation email. Please check your inbox and click the link to confirm your reservation.',
    ...
    confirmationEmailMessage:
      'Thank you for choosing Ristorante Da Gino! To confirm your reservation, please click the button below:',
    ...
    exploreDescription:
      'Discover everything we have to offer: from our authentic cuisine to our services',
    beverages: 'Beverages',
  ...
  es: {
    ...
    description:
      '¡Bienvenidos al sitio web de la Pizzería Da Gino en Den Helder! Aquí pueden disfrutar de la auténtica cocina italiana con ingredientes frescos.',
    ...
    menuDescription:
      'Platos tradicionales preparados con ingredientes frescos y recetas transmitidas de generación en generación',
    popular: 'Popular',
    ...
    tradition: 'Tradición',
    traditionDesc:
      'Desde 2010 llevamos a Den Helder la auténtica tradición culinaria italiana con recetas tradicionales',
    passion: 'Pasión',
    passionDesc: 'Cada plato se prepara con amor y dedicación para ofrecer una experiencia única',
    quality: 'Ingredientes Frescos',
    qualityDesc:
      'Utilizamos solo ingredientes frescos y de primera calidad, seleccionados cuidadosamente para garantizar el máximo sabor',
    ...
    reviewsDescription:
      'Descubre lo que dicen nuestros clientes sobre su experiencia gastronómica italiana',
    ...
    // Additional info
    allergyNotice:
      'Manejamos sus alergias o intolerancias alimentarias con el máximo cuidado durante la preparación de nuestros platos. La contaminación cruzada de alérgenos nunca puede excluirse completamente en nuestra cocina. ¡Por favor indique claramente sus alergias o intolerancias al hacer el pedido!',
    deliveryInfo:
      'Siempre tratamos de entregar su pedido lo más rápido posible. Los domingos y días festivos, los tiempos de entrega pueden ser más largos debido a la alta demanda.',
    ...
    reservationDescription:
      'Reserva tu mesa mediante nuestro widget oficial de TheFork y asegura tu lugar en segundos.',
    reservationTheForkDisclaimer:
      'Las reservas se gestionan directamente en TheFork; recibirás confirmación inmediata desde su sistema.',
    ...
    reservationPolicy:
      'Las reservas se confirman por teléfono en 2 horas. Por favor llega puntual para mantener tu mesa.',
    confirmationCall:
      'Recibirás una llamada de confirmación de nuestro personal para confirmar tu reserva.',
    arrivalTime:
      'Por favor llega a la hora reservada. Las mesas se mantienen 15 minutos después de la hora reservada.',
    ...
    emailConfirmationDescription:
      'Te hemos enviado un email de confirmación. Por favor revisa tu bandeja de entrada y haz clic en el enlace para confirmar tu reserva.',
    ...
    confirmationEmailMessage:
      '¡Gracias por elegir Ristorante Da Gino! Para confirmar tu reserva, haz clic en el botón de abajo:',
    ...
    exploreDescription:
      'Descubre todo lo que tenemos que ofrecer: desde nuestra cocina auténtica hasta nuestros servicios',
    beverages: 'Bebidas',
    beveragesDescription:
      'Descubre nuestra selección de vinos italianos, cervezas artesanales y bebidas',
    services: 'Servicios',
  ...
  fr: {
    ...
    description:
      'Bienvenue sur le site web de la Pizzeria Da Gino à Den Helder ! Ici vous pouvez déguster une cuisine italienne authentique avec des ingrédients frais.',
    ...
    ourMenu: 'Notre Carte',
    menuDescription:
      'Plats traditionnels préparés avec des ingrédients frais et des recettes transmises de génération en génération',
    popular: 'Populaire',
    ...
    tradition: 'Tradition',
    traditionDesc:
      "Depuis 2010, nous apportons à Den Helder l'authentique tradition culinaire italienne avec des recettes traditionnelles",
    passion: 'Passion',
    passionDesc:
      'Chaque plat est préparé avec amour et dévouement pour offrir une expérience unique',
    quality: 'Ingrédients Frais',
    qualityDesc:
      'Nous utilisons uniquement des ingrédients frais et de première qualité, soigneusement sélectionnés pour garantir un maximum de saveur',

    // Contact section
    contactTitle: 'Venez Nous Rendre Visite',
    contactDescription:
      'Contactez-nous pour des réservations ou venez nous rendre visite dans notre restaurant',
    ...
    ourReviews: 'Nos Avis',
    reviewsDescription:
      'Découvrez ce que nos clients disent de leur expérience gastronomique italienne',
    ...
    // Additional info
    allergyNotice:
      "Nous traitons vos allergies ou intolérances alimentaires avec le plus grand soin lors de la préparation de nos plats. La contamination croisée d'allergènes ne peut jamais être complètement exclue dans notre cuisine. Veuillez indiquer clairement vos allergies ou intolérances lors de la commande !",
    deliveryInfo:
      'Nous essayons toujours de livrer votre commande le plus rapidement possible. Les dimanches et jours fériés, les délais de livraison peuvent être plus longs en raison de la forte demande.',
    ...
    reservationDescription:
      'Réservez votre table via notre widget officiel TheFork et assurez votre place en quelques secondes.',
    reservationTheForkDisclaimer:
      'Les réservations sont gérées directement par TheFork ; vous recevrez une confirmation instantanée depuis leur système.',
    ...
    reservationPolicy:
      "Les réservations sont confirmées par téléphone dans les 2 heures. Veuillez arriver à l'heure pour garder votre table.",
    confirmationCall:
      'Vous recevrez un appel de confirmation de notre personnel pour confirmer votre réservation.',
    arrivalTime:
      "Veuillez arriver à l'heure réservée. Les tables sont maintenues 15 minutes après l'heure réservée.",
    ...
    reservationSubmitted:
      'Réservation envoyée avec succès ! Nous vous contacterons bientôt pour confirmer.',
    reservationError:
      "Erreur lors de l'envoi de la réservation. Veuillez réessayer ou nous appeler directement.",
    reservations: 'Réservations',

    // Email confirmation system
    emailConfirmation: 'Confirmation Email',
    emailConfirmationDescription:
      'Nous vous avons envoyé un email de confirmation. Veuillez vérifier votre boîte de réception et cliquer sur le lien pour confirmer votre réservation.',
    ...
    confirmationEmailMessage:
      "Merci d'avoir choisi Ristorante Da Gino! Pour confirmer votre réservation, veuillez cliquer sur le bouton ci-dessous:",
    confirmReservationButton: 'Confirmer la Réservation',
    confirmationEmailFooter:
      "Si vous n'avez pas fait cette réservation, veuillez ignorer cet email.",
    confirmationEmailAlternative:
    ...
    exploreDescription:
      'Découvrez tout ce que nous avons à offrir : de notre cuisine authentique à nos services',
    beverages: 'Boissons',
    beveragesDescription:
      'Découvrez notre sélection de vins italiens, bières artisanales et boissons',
    services: 'Services',
  ...
  de: {
    ...
    description:
      'Willkommen auf der Website der Pizzeria Da Gino in Den Helder! Hier können Sie authentische italienische Küche mit frischen Zutaten genießen.',
    ...
    menuDescription:
      'Traditionelle Gerichte zubereitet mit frischen Zutaten und Rezepten, die von Generation zu Generation weitergegeben wurden',
    popular: 'Beliebt',
    ...
    tradition: 'Tradition',
    traditionDesc:
      'Seit 2010 bringen wir nach Den Helder die authentische italienische kulinarische Tradition mit traditionellen Rezepten',
    passion: 'Leidenschaft',
    passionDesc:
      'Jedes Gericht wird mit Liebe und Hingabe zubereitet, um ein einzigartiges Erlebnis zu bieten',
    quality: 'Frische Zutaten',
    qualityDesc:
      'Wir verwenden nur frische, erstklassige Zutaten, sorgfältig ausgewählt für maximalen Geschmack',

    // Contact section
    contactTitle: 'Besuchen Sie Uns',
    contactDescription:
      'Kontaktieren Sie uns für Reservierungen oder besuchen Sie uns in unserem Restaurant',
    ...
    deliveryInfo:
      'Wir versuchen immer, Ihre Bestellung so schnell wie möglich zu liefern. An Sonn- und Feiertagen können sich die Lieferzeiten aufgrund der hohen Nachfrage verlängern.',
    ...
    reservationDescription:
      'Reservieren Sie Ihren Tisch über unser offizielles TheFork-Widget und sichern Sie sich Ihren Platz in wenigen Sekunden.',
    reservationTheForkDisclaimer:
      'Die Reservierungen werden direkt von TheFork verwaltet; Sie erhalten sofort eine Bestätigung von deren System.',
    ...
    reservationPolicy:
      'Reservierungen werden telefonisch innerhalb von 2 Stunden bestätigt. Bitte kommen Sie pünktlich, um Ihren Tisch zu behalten.',
    confirmationCall:
      'Sie erhalten einen Bestätigungsanruf von unserem Personal zur Bestätigung Ihrer Reservierung.',
    arrivalTime:
      'Bitte kommen Sie zur gebuchten Zeit. Tische werden 15 Minuten nach der gebuchten Zeit gehalten.',
    ...
    reservationSubmitted:
      'Reservierung erfolgreich gesendet! Wir werden uns bald mit Ihnen in Verbindung setzen, um zu bestätigen.',
    reservationError:
      'Fehler beim Senden der Reservierung. Bitte versuchen Sie es erneut oder rufen Sie uns direkt an.',
    reservations: 'Reservierungen',

    // Email confirmation system
    emailConfirmation: 'E-Mail-Bestätigung',
    emailConfirmationDescription:
      'Wir haben Ihnen eine Bestätigungs-E-Mail gesendet. Bitte überprüfen Sie Ihren Posteingang und klicken Sie auf den Link, um Ihre Reservierung zu bestätigen.',
    ...
    confirmationEmailMessage:
      'Vielen Dank, dass Sie Ristorante Da Gino gewählt haben! Um Ihre Reservierung zu bestätigen, klicken Sie bitte auf den Button unten:',
    confirmReservationButton: 'Reservierung Bestätigen',
    confirmationEmailFooter:
      'Wenn Sie diese Reservierung nicht vorgenommen haben, ignorieren Sie diese E-Mail.',
    confirmationEmailAlternative:
      'Wenn der Button nicht funktioniert, kopieren Sie diesen Link und fügen Sie ihn in Ihren Browser ein:',
    ...
    exploreDescription:
      'Entdecken Sie alles, was wir zu bieten haben: von unserer authentischen Küche bis zu unseren Dienstleistungen',
    beverages: 'Getränke',
    beveragesDescription:
      'Entdecken Sie unsere Auswahl an italienischen Weinen, handwerklichen Bieren und Getränken',
    services: 'Dienstleistungen',
    servicesDescription:
      'Online-Reservierungen, Lieferung nach Hause und Dienstleistungen für unsere Kunden',
    delivery: 'Lieferung',
  ...
  nl: {
    ...
    description:
      'Welkom op de website van Pizzeria Da Gino in Den Helder! Hier kunt u genieten van authentieke Italiaanse keuken met verse ingrediënten.',
    ...
    ourMenu: 'Ons Menu',
    menuDescription:
      'Traditionele gerechten bereid met verse ingrediënten en recepten doorgegeven van generatie op generatie',
    popular: 'Populair',
    ...
    tradition: 'Traditie',
    traditionDesc:
      'Sinds 2010 brengen we naar Den Helder de authentieke Italiaanse culinaire traditie met traditionele recepten',
    passion: 'Passie',
    passionDesc:
      'Elk gerecht wordt met liefde en toewijding bereid om een unieke ervaring te bieden',
    quality: 'Verse Ingrediënten',
    qualityDesc:
      'We gebruiken alleen verse, eersteklas ingrediënten, zorgvuldig geselecteerd voor maximale smaak',

    // Contact section
    contactTitle: 'Kom Ons Bezoeken',
    contactDescription:
      'Neem contact met ons op voor reserveringen of kom ons bezoeken in ons restaurant',
    ...
    // Additional info
    allergyNotice:
      'Wij behandelen uw allergieën of voedselintoleranties met de grootste zorg tijdens de bereiding van onze gerechten. Kruisbesmetting van allergenen kan nooit volledig worden uitgesloten in onze keuken. Geef uw allergieën of intoleranties duidelijk aan bij het bestellen!',
    deliveryInfo:
      'We proberen uw bestelling altijd zo snel mogelijk te bezorgen. Op zondag en feestdagen kunnen de bezorgtijden langer zijn vanwege de hoge vraag.',
    ...
    reservationDescription:
      'Reserveer je tafel via onze officiële TheFork-widget en verzeker je plek in enkele seconden.',
    reservationTheForkDisclaimer:
      'Reserveringen worden rechtstreeks door TheFork afgehandeld; je ontvangt meteen een bevestiging vanuit hun systeem.',
    ...
    reservationPolicy:
      'Reserveringen worden telefonisch bevestigd binnen 2 uur. Kom alsjeblieft op tijd om je tafel te behouden.',
    confirmationCall:
      'Je ontvangt een bevestigingsoproep van ons personeel om je reservering te bevestigen.',
    arrivalTime:
      'Kom alsjeblieft op de gereserveerde tijd. Tafels worden 15 minuten na de gereserveerde tijd vastgehouden.',
    ...
    reservationSubmitted:
      'Reservering succesvol verzonden! We nemen binnenkort contact met je op om te bevestigen.',
    reservationError:
      'Fout bij het verzenden van de reservering. Probeer opnieuw of bel ons direct.',
    reservations: 'Reserveringen',

    // Email confirmation system
    emailConfirmation: 'E-mail Bevestiging',
    emailConfirmationDescription:
      'We hebben je een bevestigings-e-mail gestuurd. Controleer je inbox en klik op de link om je reservering te bevestigen.',
    ...
    confirmationEmailGreeting: 'Hallo',
    confirmationEmailMessage:
      'Bedankt voor het kiezen van Ristorante Da Gino! Om je reservering te bevestigen, klik op de knop hieronder:',
    ...
    exploreDescription:
      'Ontdek alles wat we te bieden hebben: van onze authentieke keuken tot onze services',
    beverages: 'Drankjes',
    beveragesDescription:
      'Ontdek onze selectie Italiaanse wijnen, ambachtelijke bieren en drankjes',
    services: 'Services',
  ...
  pt: {
    ...
    description:
      'Bem-vindos ao site web da Pizzeria Da Gino em Den Helder! Aqui podem saborear a autêntica cozinha italiana com ingredientes frescos.',
    ...
    menuDescription:
      'Pratos tradicionais preparados com ingredientes frescos e receitas passadas de geração em geração',
    popular: 'Popular',
    ...
    tradition: 'Tradição',
    traditionDesc:
      'Desde 2010 trazemos para Den Helder a autêntica tradição culinária italiana com receitas tradicionais',
    passion: 'Paixão',
    passionDesc: 'Cada prato é preparado com amor e dedicação para oferecer uma experiência única',
    quality: 'Ingredientes Frescos',
    qualityDesc:
      'Usamos apenas ingredientes frescos e de primeira qualidade, cuidadosamente selecionados para garantir o máximo sabor',

    // Contact section
    contactTitle: 'Venha Nos Visitar',
    contactDescription:
      'Entre em contato conosco para reservas ou venha nos visitar em nosso restaurante',
    ...
    reviewsDescription:
      'Descubra o que nossos clientes dizem sobre sua experiência gastronômica italiana',
    ...
    // Additional info
    allergyNotice:
      'Tratamos suas alergias ou intolerâncias alimentares com o máximo cuidado durante a preparação de nossos pratos. A contaminação cruzada de alérgenos nunca pode ser completamente excluída em nossa cozinha. Por favor, indique claramente suas alergias ou intolerâncias ao fazer o pedido!',
    deliveryInfo:
      'Sempre tentamos entregar seu pedido o mais rápido possível. Aos domingos e feriados, os tempos de entrega podem ser mais longos devido à alta demanda.',
    ...
    makeReservation: 'Reservar Mesa',
    reservationDescription:
      'Reserve sua mesa pelo nosso widget oficial TheFork e garanta seu lugar em segundos.',
    reservationTheForkDisclaimer:
      'As reservas são gerenciadas diretamente pelo TheFork; você receberá uma confirmação imediata do sistema deles.',
    ...
    reservationPolicy:
      'As reservas são confirmadas por telefone em 2 horas. Por favor, chegue no horário para manter sua mesa.',
    confirmationCall:
      'Você receberá uma ligação de confirmação da nossa equipe para confirmar sua reserva.',
    arrivalTime:
      'Por favor, chegue no horário reservado. As mesas são mantidas por 15 minutos após o horário reservado.',
    ...
    reservationSubmitted:
      'Reserva enviada com sucesso! Entraremos em contato em breve para confirmar.',
    ...
    emailConfirmationDescription:
      'Enviamos um email de confirmação para você. Verifique sua caixa de entrada e clique no link para confirmar sua reserva.',
    ...
    confirmationEmailMessage:
      'Obrigado por escolher o Ristorante Da Gino! Para confirmar sua reserva, clique no botão abaixo:',
    confirmReservationButton: 'Confirmar Reserva',
    ...
    exploreDescription:
      'Descubra tudo o que temos a oferecer: desde nossa cozinha autêntica até nossos serviços',
    beverages: 'Bebidas',
    beveragesDescription:
      'Descubra nossa seleção de vinhos italianos, cervejas artesanais e bebidas',
    services: 'Serviços',
